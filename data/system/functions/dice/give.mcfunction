...
execute if entity @e[tag=SM,tag=!OnlyEventDice,tag=!OnlyItemDice,tag=!OnlyHyperDice] if entity @s[scores={Random=11..100}] run advancement grant @s only system:give_dice_event
