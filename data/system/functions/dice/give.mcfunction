...
execute if entity @e[tag=SM,tag=!OnlyEventDice,tag=!OnlyItemDice,tag=!OnlyHyperDice] run scoreboard players operation @s Random %= $100 AddTmp
execute if entity @e[tag=SM,tag=!OnlyEventDice,tag=!OnlyItemDice,tag=!OnlyHyperDice] run scoreboard players add @s Random 1
execute if entity @e[tag=SM,tag=!OnlyEventDice,tag=!OnlyItemDice,tag=!OnlyHyperDice] if entity @s[scores={Random=51..100}] run advancement grant @s only system:give_dice_event
execute if entity @e[tag=SM,tag=!OnlyEventDice,tag=!OnlyItemDice,tag=!OnlyHyperDice] if entity @s[scores={Random=11..50}] run advancement grant @s only system:give_dice_item
