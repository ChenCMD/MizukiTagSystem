...
execute if entity @e[tag=SM,scores={UseRuleSelect=1}] as @a[tag=Dice_Death] run function system:mode/1
execute if entity @e[tag=SM,scores={UseRuleSelect=2}] as @a[tag=Dice_Death] run function system:mode/2
execute if entity @e[tag=SM,scores={UseRuleSelect=3}] as @a[tag=Dice_Death] run function system:mode/3
