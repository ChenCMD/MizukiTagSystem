...
execute if entity @s[team=Hunter] run tellraw @a [{"text":"[ダイス]","color":"dark_red","bold":true},{"text":" 40秒間脱獄不可能になった！","color":"aqua","bold":false}]
execute if entity @s[team=Hunter] run data merge entity @e[tag=SM,nbt={FallDistance:138204.6f},limit=1] {PortalCooldown:800}