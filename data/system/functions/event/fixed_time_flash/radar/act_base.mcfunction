...
execute if entity @s[scores={EventRadarCount=15..}] at @s run function system:event/fixed_time_flash/radar/act
scoreboard players reset @s[scores={EventRadarCount=15..}] EventRadarCount
