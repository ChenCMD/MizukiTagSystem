...
replaceitem entity @s hotbar.8 minecraft:slime_ball{HyperJump:1b,HideFlags:1,Enchantments:[{id:protection,lvl:1}],display:{Name:"\"§bハイパージャンプ\"",Lore:["§a持った状態でシフトで溜める","§a溜め中は動くことが出来ない","§a最大10m飛ぶことが出来る"]}}
