...
execute if entity @a[team=Hunter,distance=..2.5] at @a[team=Hunter,distance=..2.5] run summon area_effect_cloud ~ ~1.5 ~ {Particle:"item cookie",ReapplicationDelay:2147483647,Radius:0.5f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:200,DurationOnUse:0,Age:0,WaitTime:0}
##メッセージ送信
