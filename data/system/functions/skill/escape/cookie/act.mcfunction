...
##エフェクト付与
effect give @a[team=Hunter,distance=..2.5] minecraft:slowness 10 10 true
effect give @a[team=Hunter,distance=..2.5] minecraft:jump_boost 10 128 true
effect give @a[team=Hunter,distance=..2.5] minecraft:unluck 10 0 false
effect give @a[team=Hunter,distance=..2.5] minecraft:blindness 10 0 true
