...
execute if score @s Random matches 1..10 run effect give @s minecraft:blindness 5 0 true
...
execute if score @s Random matches 36..50 run effect give @s minecraft:unluck 10 0 false
execute if score @s Random matches 51..70 run particle minecraft:end_rod ~ ~ ~ 0 10 0 0 70 force
execute if score @s Random matches 71..90 run playsound minecraft:entity.bat.ambient master @a[distance=..30]
