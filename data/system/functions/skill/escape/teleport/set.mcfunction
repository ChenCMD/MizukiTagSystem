...
execute at @s run summon armor_stand ~ ~0.5 ~ {Tags:["FacingTP"],NoGravity:1b,Small:1b,Marker:1b,Invisible:1b,Invulnerable:1b}
...
execute as @e[tag=FacingTP,limit=1] at @s if block ~ ~ ~ #system:teleport if block ^ ^ ^0.1 #system:teleport if block ^ ^1 ^0.1 #system:teleport run function system:skill/escape/teleport/loop
