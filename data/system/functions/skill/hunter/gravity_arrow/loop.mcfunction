...
execute if entity @s if score @s GravityCount < $GravityArrowLimit AddTmp at @s if block ^ ^ ^0.2 #system:targets run function system:skill/hunter/gravity_arrow/loop
