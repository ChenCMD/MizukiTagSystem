...
execute as @a[scores={Jump=0..},nbt={ActiveEffects:[{Id:2b,Amplifier:9b}]},team=Hunter] run effect clear @s minecraft:slowness
...
execute as @a[nbt=!{SelectedItem:{tag:{HyperJump:1b}}},nbt={ActiveEffects:[{Id:2b,Amplifier:9b}]},team=Hunter] run effect clear @s minecraft:slowness
