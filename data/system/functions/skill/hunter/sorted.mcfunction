...
execute if entity @s[team=Hunter,level=0,nbt=!{ActiveEffects:[{Id:27b}]},tag=GravityArrowReady] run xp add @s 20 levels
...
execute if entity @s[team=Hunter,level=0,nbt=!{ActiveEffects:[{Id:27b}]},tag=ChaseArrowReady] run xp add @s 10 levels
