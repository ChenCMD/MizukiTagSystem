...
execute if entity @e[type=arrow,distance=..5,sort=nearest,limit=1] if entity @s[tag=!GravityArrowReady,tag=!ChaseArrowReady] run data merge entity @e[type=arrow,distance=..5,sort=nearest,limit=1] {Color:-1,crit:0b}
