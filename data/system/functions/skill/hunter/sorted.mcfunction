...
execute if entity @s[team=Hunter,level=0,nbt=!{ActiveEffects:[{Id:27b}]},tag=GravityArrowReady] as @e[type=arrow,distance=..5,sort=nearest,limit=1] run function system:skill/hunter/gravity_arrow/set
