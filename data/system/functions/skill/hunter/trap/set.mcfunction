execute at @s run summon area_effect_cloud ~ ~0.5 ~ {Particle:"dolphin",ReapplicationDelay:2147483647,Radius:0.01f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:2400,DurationOnUse:0f,Age:0,WaitTime:0,Tags:["Trap"]}
