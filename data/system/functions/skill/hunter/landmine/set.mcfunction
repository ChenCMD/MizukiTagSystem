execute at @s run summon area_effect_cloud ~ ~0.5 ~ {Particle:"falling_dust barrier",ReapplicationDelay:2147483647,Radius:0.01f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:3600,DurationOnUse:0f,Age:0,WaitTime:0,Tags:["Landmine"]}
