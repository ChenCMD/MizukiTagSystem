...
execute as @a[tag=Kim2] run scoreboard players add #Counter2 kills_in_match 1
...
execute as @a[tag=Kim3] run scoreboard players add #Counter3 kills_in_match 1
...
scoreboard players reset #PlayerCount Ver
