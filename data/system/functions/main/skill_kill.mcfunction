tellraw @a ["",{"selector":"@a[tag=SkillDeath]","color":"green"},{"text":" が ","color":"green"},{"selector":"@s","color":"green"},{"text":" のランドマインで爆散した...","color":"green"}]
