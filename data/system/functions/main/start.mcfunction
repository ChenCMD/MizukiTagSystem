...
execute if entity @s[scores={PlayerCount-AA=8}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 8 run team join Hunter @a[sort=random,limit=8,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
execute if entity @s[scores={PlayerCount-AA=9}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 9 run team join Hunter @a[sort=random,limit=9,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
execute if entity @s[scores={PlayerCount-AA=10}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 10 run team join Hunter @a[sort=random,limit=10,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
execute if entity @s[scores={PlayerCount-AA=11}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 11 run team join Hunter @a[sort=random,limit=11,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
execute if entity @s[scores={PlayerCount-AA=12}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 12 run team join Hunter @a[sort=random,limit=12,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
execute if entity @s[scores={PlayerCount-AA=13}] if score @s UTSTCount >= @s PlayerCount-AA if entity @a[scores={UseTeamSelect=2}] if score @s PlayerCount-AA matches 13 run team join Hunter @a[sort=random,limit=13,scores={UseTeamSelect=2},gamemode=!spectator,team=!OP]
#逃走者弱体化付与
