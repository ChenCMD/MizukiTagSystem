...
execute as @e[tag=SM,nbt={FallDistance:138204.6f},limit=1] if entity @s[scores={GameTimeA=20..}] if entity @s[scores={GameTimeB=1..}] as @a[team=Hunter] run function system:armor/hunter
execute as @e[tag=SM,nbt={FallDistance:138204.6f},limit=1] if entity @s[scores={GameTimeA=20..}] if entity @s[scores={GameTimeB=1..}] as @a[team=Escape] unless entity @s[scores={InvisibleArmor=0..}] run function system:armor/escape
