...
execute if entity @a[tag=Death] as @a[tag=Death] if entity @e[tag=SM,scores={UseRuleSelect=2}] run function system:mode/2
execute if entity @a[tag=Death] as @a[tag=Death] if entity @e[tag=SM,scores={UseRuleSelect=3}] run function system:mode/3
tag @a remove Death
