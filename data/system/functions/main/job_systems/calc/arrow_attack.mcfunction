...
execute if entity @a[tag=ArrowDeath] as @a[tag=ArrowDeath] if entity @e[tag=SM,nbt={FallDistance:138204.6f},scores={UseRuleSelect=1}] run function system:mode/1
execute if entity @a[tag=ArrowDeath] as @a[tag=ArrowDeath] if entity @e[tag=SM,nbt={FallDistance:138204.6f},scores={UseRuleSelect=2}] run function system:mode/2
execute if entity @a[tag=ArrowDeath] as @a[tag=ArrowDeath] if entity @e[tag=SM,nbt={FallDistance:138204.6f},scores={UseRuleSelect=3}] run function system:mode/3
