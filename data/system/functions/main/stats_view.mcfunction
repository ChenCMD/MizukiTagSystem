...
tellraw @s [{"text":"最高連続勝利数","color":"green"},{"text":": ","color":"white"},{"score":{"name":"@s","objective":"WinStrokeMAX","color":"green"}},{"text":" (","color":"white"},{"score":{"name":"@s","objective":"WinStrokeMAX","color":"green"}},{"text":") ","color":"white"},{"text":"回","color":"green"}]
